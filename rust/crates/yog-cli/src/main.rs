...
{patch}"#,
        ...
        ctor_ver     = workspace_ctor_version(),
...
fn publish_exports() -> Result<(), String> {
    ...
    let ctor_ver = workspace_ctor_version();
...
/// ctor version embedded at compile time via `build.rs`.
fn workspace_ctor_version() -> String {
    env!("CTOR_VERSION").to_string()
}
