    ...
    ($mod_ty:ty) => {
        ...
        pub unsafe extern "C" fn yog_mod_register(
            ...
            let outcome = ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(|| {
                ...
                // Auto-register all #[yog_export] functions (populated via #[ctor] before main).
...
// ── Auto-export registry (populated via #[ctor] before main) ────────────

/// An entry in the export registry.
#[doc(hidden)]
...
/// An entry in the pending-imports registry.
#[doc(hidden)]
...
/// Global export registry — populated by `#[ctor]` functions generated
/// by `#[yog_export]` before `main()`.
#[doc(hidden)]
...
/// Global pending-imports registry — populated by `#[ctor]` functions
/// generated by `import!` before `main()`.
#[doc(hidden)]
